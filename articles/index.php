...
$APPLICATION->SetPageProperty("keywords", "KIDKA ™ - Новости");
$APPLICATION->SetPageProperty("description", "KIDKA ™ - Новости");
if ($APPLICATION->GetCurPage() === '/articles/') {
	$APPLICATION->SetPageProperty("body_class", "page-articels");
}
$APPLICATION->SetTitle("KIDKA ™ - Новости");
?>
