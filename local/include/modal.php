...
<div class="modal fade" id="more_information" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="modal-body">
                <p style="text-align: center; color: #333;">Укажите контактные данные - с вами свяжется специалист и ответит на все волнующие вопросы</p>
                <?$APPLICATION->IncludeComponent(
                    "bitrix:form",
                    "popup",
                    array(
