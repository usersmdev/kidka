...
//var_dump($arResult["ITEMS"][$PID]["VALUES"][$key]['VALUE']);
	...
	foreach($arItem["VALUES"] as $key => $ar)
	{
		...
		)
		{
			...
			elseif($_CHECK[$ar["CONTROL_NAME"]] == $ar["HTML_VALUE"])
			{
                ...
                foreach ($arParams['CHECK_PROPERTY'] as $key_property => $value_property) {
                    if ($arResult["ITEMS"][$PID]['CODE'] == $key_property) {
                        if ($arResult["ITEMS"][$PID]["VALUES"][$key]['VALUE'] == $value_property) {
                            if ($arResult["ITEMS"][$PID]["VALUES"][$key]["CHECKED"]) {
                                $arResult["ITEMS"][$PID]["VALUES"][$key]["CHECKED"] = false;
                                $arResult["ITEMS"][$PID]["DISPLAY_EXPANDED"] = "N";
                                //$arResult["JS_FILTER_PARAMS"]["SEF_SET_FILTER_URL"] = '/offers/sport/clear/show/';
                                //$arResult["FORM_ACTION"] = '/offers/sport/clear/show/';
        ...
        elseif (sizeof($arParams['CHECK_PROPERTY'])) {
            foreach ($arParams['CHECK_PROPERTY'] as $key_property => $value_property) {
                if ($arResult["ITEMS"][$PID]['CODE'] == $key_property) {
                    if ($arResult["ITEMS"][$PID]["VALUES"][$key]['VALUE'] == $value_property && is_null($arResult["ITEMS"][$PID]["VALUES"][$key]["CHECKED"])) {
                        $arResult["ITEMS"][$PID]["VALUES"][$key]["CHECKED"] =true;
                        $arResult["ITEMS"][$PID]["DISPLAY_EXPANDED"] = "Y";
                        //$arResult["JS_FILTER_PARAMS"]["SEF_SET_FILTER_URL"] =  '/offers/sport/city-is-'.$value_property.'/show/';
                    }else{
                        //$arResult["ITEMS"][$PID]["VALUES"][$key]["CHECKED"] = false;
                        //$arResult["ITEMS"][$PID]["DISPLAY_EXPANDED"] = "N";
                    }
...
if (($arResult["JS_FILTER_PARAMS"]["SEF_SET_FILTER_URL"] ?? ''))
{
    ...
    if($GLOBALS['mraz']){
        $arResult["FILTER_URL"] = '/offers/sport/clear/show/';
        $arResult["JS_FILTER_PARAMS"]["SEF_SET_FILTER_URL"] = '/offers/sport/clear/show/';
    }
    ...
    $clearURL = $arResult["JS_FILTER_PARAMS"]["SEF_SET_FILTER_URL"];
