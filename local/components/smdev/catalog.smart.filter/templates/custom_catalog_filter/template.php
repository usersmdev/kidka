...
if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal" ?>" id="filter_d">
    <div class="bx-filter-section container-fluid">
        <div class="row">
            <div class="<?
            if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"): ?>col-sm-6 col-md-4<?
            else: ?>col-lg-12<?
            endif ?> bx-filter-title"></div>
        </div>
        <form name="<?
                            ...
                            <div class="row bx-filter-parameters-box-container">
                                        ...
                                        foreach ($arItem["VALUES"] as $val => $ar): ?>
                                            <div class="radio">
                                                <label data-role="label_<?= $ar["CONTROL_ID"] ?>"
                                                       class="bx-filter-param-label" for="<?
                                                echo $ar["CONTROL_ID"] ?>">
													<span class="bx-filter-input-checkbox <?
                                ...
                                ?>
                                    <div class="col-xs-12">
                                        ...
                                        $parentID = $res->GetNext();

                                        if ($parentID || $arItem['CODE'] == 'SECTION_PROPERTY') {
                                            $rsParentSection = CIBlockSection::GetByID($parentID['IBLOCK_SECTION_ID']);
                                            $arParentSection = $rsParentSection->GetNext();
                                            $parentUrl = $arParentSection['CODE'];


                                            if ($arParentSection && $arItem['CODE'] == 'SECTION_PROPERTY') {
                                                $arFilter = array(
                                                ...
                                                $rsSect = CIBlockSection::GetList(array('iblock_id ' => 'desc'),
                                                    $arFilter);
                                            ...
                                            }elseif ($arItem['CODE'] == 'DIRECTION_SERVICE'){
                                                $iblock_id = \GetID\Helper\IBlock::getInfoByCodeCache('organization');
                                                $infoblock = $iblock_id['IBLOCK_ID'];
                                                $rs_Section = CIBlockSection::GetList(array('left_margin' => 'asc'), array('IBLOCK_ID' => $infoblock, 'DEPTH_LEVEL' => 1));
...
<!--                                        <div>-->
<!--                                            <a href="/test-catalog/sport/--><?php //= $arSect['CODE'] ?><!--/"-->
<!--                                               for="check_--><?php //= $arSect['ID'] ?><!--">--><?php //= $arSect['NAME'] ?><!--</a>-->
<!--                                        </div>-->
                ...
                <div class="col-xs-12 bx-filter-button-box">
                    <div class="bx-filter-block">
                        <div class="bx-filter-parameters-box-container">
                            <div id="view_map">Показать на карте</div>
