<?
if ($_REQUEST['filter']) {
	if ($_REQUEST['filter'] == 'msk') {
		$GLOBALS['arFilterNews'] = [
			'!PROPERTY_POINT_MSK' => false,
		];
	}
	if ($_REQUEST['filter'] == 'spb') {
		$GLOBALS['arFilterNews'] = [
			'!PROPERTY_POINT_SPB' => false,
		];
	}
	if ($_REQUEST['filter'] == 'lerua') {
		$GLOBALS['arFilterNews'] = [
			'!PROPERTY_POINT_LERUA' => false,
		];
	}
	if ($_REQUEST['filter'] == 'petr') {
		$GLOBALS['arFilterNews'] = [
			'!PROPERTY_POINT_PETR' => false,
		];
	}
	if ($_REQUEST['filter'] == 'region') {
		$GLOBALS['arFilterNews'] = [
			'!PROPERTY_POINT_REGION' => false,
		];
	}
}
?>
