...
if($arMenuParametrs = CMax::GetDirMenuParametrs(__DIR__))
{
	if($arMenuParametrs['MENU_SHOW_SECTIONS'] == 'Y')
	{
		...
		// $catalog_id = \Bitrix\Main\Config\Option::get('aspro.max', 'CATALOG_SECTIONS_IBLOCK_ID', CMaxCache::$arIBlocks[SITE_ID]['xmlcatalog']['catalog_new'][0]);
...
/*?><pre><? print_r(['arSections' => $arSections]); ?></pre><?*/
/*?><pre><? print_r(['aMenuLinksExt' => $aMenuLinksExt]); ?></pre><?*/
