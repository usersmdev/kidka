...
if($arRegion)
{
	...
	if($catalogID = \Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", \Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", '72')))
	{
...
if (Bitrix\Main\Loader::includeModule('catalog')) {
	...
	$GLOBALS['arrProductsFilter']['!CATALOG_PRICE_'.$basePrice['ID']] = false;
}
?>
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"IBLOCK_ID" => CATALOG_IBLOCK_ID,//\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", '72'),
