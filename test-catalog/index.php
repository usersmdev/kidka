...
?><div class="service_catalog">
	...
	Array(
		...
		"SEF_MODE" => "Y",
		"SEF_URL_TEMPLATES" => array("sections"=>"#SECTION_CODE#/121a11","section"=>"#SECTION_CODE_PATH#/","element"=>"#SECTION_CODE#/#ELEMENT_CODE#/","compare"=>"compare.php?action=#ACTION_CODE#","smart_filter"=>"#SECTION_CODE_PATH#/#SMART_FILTER_PATH#/show/",),
		"SET_LAST_MODIFIED" => "N",
		"SET_STATUS_404" => "N",
		"SET_TITLE" => "Y",
		"SHOW_404" => "N",
