...
$arYandexFields = array('name', 'vendor', 'vendorCode', 'model', 'author', 'publisher', 'year', 'ISBN', 'volume', 'part', 'language', 'binding', 'page_extent', 'table_of_contents', 'performed_by', 'performance_type', 'storage', 'format', 'recording_length', 'series', 'artist', 'title', 'year', 'media', 'starring', 'director', 'originalName', 'country', 'description', 'sales_notes', 'promo', 'aliases', 'provider', 'tarifplan', 'xCategory', 'additional', 'worldRegion', 'region', 'days', 'dataTour', 'hotel_stars', 'room', 'meal', 'included', 'transport', 'price_min', 'price_max', 'options', 'manufacturer_warranty', 'country_of_origin', 'downloadable', 'barcode', 'param', 'place', 'hall', 'hall_part', 'is_premiere', 'is_kids', 'date',);
...
$XML_DATA["XML_DATA"]["vendor"] = "17";
#$XML_DATA["XML_DATA"]["vendorCode"] = "19";
#$XML_DATA["XML_DATA"]["model"] = "19";
$XML_DATA["XML_DATA"]["vendorCode"] = "19";

$XML_DATA["XML_DATA"]["barcode"] = "18";
//$XML_DATA["XML_DATA"]["manufacturer_warranty"] = "true";
$XML_DATA["XML_DATA"]["PARAMS"][0] = "37";
$XML_DATA["XML_DATA"]["PARAMS"][1] = "26";
$XML_DATA["XML_DATA"]["PARAMS"][2] = "27";
$XML_DATA["XML_DATA"]["PARAMS"][3] = "28";
$XML_DATA["XML_DATA"]["PARAMS"][4] = "40";
$XML_DATA["XML_DATA"]["PARAMS"][5] = "41";
$XML_DATA["XML_DATA"]["PARAMS"][6] = "39";
$XML_DATA["XML_DATA"]["PARAMS"][7] = "29";
$XML_DATA["XML_DATA"]["PARAMS"][8] = "16";
$XML_DATA["XML_DATA"]["PARAMS"][9] = "31";
$XML_DATA["XML_DATA"]["PARAMS"][10] = "38";
//$XML_DATA["XML_DATA"]["PARAMS"][11] = "38";
$XML_DATA["XML_DATA"]["PARAMS"][12] = "36";
...
$SETUP_FILE_NAME = "/bitrix/catalog_export/yandex.php";
/*
...
if (strlen($strExportErrorMessage)<=0)
{
	...
	while ($obElement = $db_acc->GetNextElement())
	{
		...
		*/
		...
		//if ($offers_count > 150) break;
		
		// ���� ���� ������������� - ����������
		//if ('vendor' == $key ) {
		
		//	deb($arAcc);
		if (empty($arAcc["PROPERTIES"]["PRODUCER"]["VALUE"])) continue;
			
		//���� ������� ���� - ���������� 
		if (empty($arAcc["PROPERTIES"]["CML2_ARTICLE"]["VALUE"])) continue;	
		//}
			...
			switch ($key)
			{
				...
				/*case 'description': 
					$strTmpOff.= 
						...
						"</description>\n";
				break;*/
				//$strTmpOff.= "<sales_notes>���������� ����������.</sales_notes>\n";
