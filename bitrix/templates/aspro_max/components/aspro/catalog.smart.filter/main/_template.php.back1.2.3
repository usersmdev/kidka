						...
						<div class="bx_filter_parameters">
							...
							foreach($arResult["ITEMS"] as $key=>$arItem)
							{
								...
								<div class="bx_filter_parameters_box <?=$class;?>" data-expanded="<?=($arItem["DISPLAY_EXPANDED"] ? $arItem["DISPLAY_EXPANDED"] : "N");?>" data-prop_code=<?=strtolower($arItem["CODE"]);?> data-property_id="<?=$arItem["ID"]?>">
									...
									<div class="bx_filter_block  <?=($arItem["CODE"] != "IN_STOCK" && $arItem["DISPLAY_TYPE"] != 'A' ? '' : '');?> <?=($arItem["CODE"] != "IN_STOCK" && $arItem["PROPERTY_TYPE"]!="N" && ($arItem["DISPLAY_TYPE"] != "P" && $arItem["DISPLAY_TYPE"] != "R") ? "limited_block srollbar-custom" : "");?>" <?=$style;?>>
										<div class="bx_filter_parameters_box_container <?=($arItem["DISPLAY_TYPE"]=="G" ? "pict_block" : "");?>">
										<?
										$arCur = current($arItem["VALUES"]);
							...
							<div class="bx_filter_button_box btns ajax-btns">
								<div class="bx_filter_block">
									<div class="bx_filter_parameters_box_container">
										...
										<button class="bx_filter_search_reset btn btn-default btn-transparent pull-left" type="reset" id="del_filter" name="del_filter" data-href="" title="<?=Loc::getMessage("CT_BCSF_DEL_FILTER")?>">
