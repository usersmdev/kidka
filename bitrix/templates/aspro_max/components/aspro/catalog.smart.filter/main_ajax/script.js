...
JCSmartFilter.prototype.filterCatalog = function (url, set_disabled, reset, count)
{
	...
	$.ajax({
		...
		success: function(html){
			if($('.main-catalog-wrapper.catalog_in_content .js-load-wrapper').length){
				$('.main-catalog-wrapper.catalog_in_content .js-load-wrapper').html(html);
			} else{
			...
			//for brands filter in ajax
			if($('.main-catalog-wrapper.catalog_in_content .js_wrapper_items').length){
				$('.bx_filter_search_reset').removeClass('hidden');
				$('.bx_filter_button_box .bx_filter_search_reset').removeClass('hidden');
			}
		}
	})
}
