...
<?else:?>
	<?if($arResult['ITEMS']):?>
		<div class="viewed-wrapper swipeignore <?=$templateName;?>">
			...
			<div class="block-items flexbox flexbox--row owl-carousel owl-theme owl-bg-nav short-nav hidden-dots visible-nav loading-state block-items--margined" data-plugin-options='{"nav": true, "autoplay" : false, "autoplayTimeout" : "3000", "margin": 10, "smartSpeed":1000, <?=(count($arResult["ITEMS"]) > 5 ? "\"loop\": true," : "")?> "responsiveClass": true, "responsive":{"0":{"items": 1},"600":{"items": 2},"768":{"items": 3},"992":{"items": 4},"1200":{"items": 5}}}'>
