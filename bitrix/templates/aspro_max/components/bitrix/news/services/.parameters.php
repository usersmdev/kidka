...
$arTemplateParameters = array_merge($arPageBlocksParams, array(
	...
	"IBLOCK_LINK_OFFERS_ID" => Array( 
            "NAME" => GetMessage("IBLOCK_LINK_OFFERS_NAME"), 
            "TYPE" => "STRING", 
            "DEFAULT" => "", 
        ),
	"BLOCK_OFFERS_NAME" => Array( 
            "NAME" => GetMessage("BLOCK_OFFERS_NAME_TITLE"), 
            "TYPE" => "STRING", 
            "DEFAULT" => "",
		),
	"IBLOCK_LINK_CONTENTS_ID" => Array( 
            "NAME" => GetMessage("IBLOCK_LINK_CONTENTS_NAME"), 
            "TYPE" => "STRING", 
            "DEFAULT" => "", 
        ),
	"BLOCK_CONTENTS_NAME" => Array( 
            "NAME" => GetMessage("BLOCK_CONTENTS_NAME_TITLE"), 
            "TYPE" => "STRING", 
            "DEFAULT" => "",
        ),
...
$arTemplateParameters['DETAIL_BLOCKS_ALL_ORDER'] = array(  
	...
	'JS_DATA' => Json::encode(array( 
		...
		'offers' => GetMessage('CP_BC_TPL_CONTENT_BLOCK_OFFERS'),
		'contents' => GetMessage('CP_BC_TPL_CONTENT_BLOCK_CONTENTS'),
	...
	'DEFAULT' => 'tizers,form_order,desc,goods,char,gallery,docs,services,news,vacancy,blog,reviews,projects,partners,offers,contents,staff,brands,landings,comments'  
);
