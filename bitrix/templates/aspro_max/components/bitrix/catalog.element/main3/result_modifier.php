...
// /*associated extra*/
// $arResult['ASSOCIATED_EXTRA'] = array(
// 	'!ID' => $arResult['ID'],
// 	'PROPERTY_SECTION_ID' => $arResult['PROPERTIES']['SECTION_ID']['VALUE'],
// );

// $arResult['ASSOCIATED_EXTRA']['IBLOCK_ID'] = $arParams['IBLOCK_ID'];
// CMax::makeElementFilterInRegion($arResult['ASSOCIATED_EXTRA']);
...
CatalogHelper::fixItem($arResult, $arParams);
?>