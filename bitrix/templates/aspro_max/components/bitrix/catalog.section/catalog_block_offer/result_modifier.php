...
$arResult['SHOW_ONE_CLICK_BUY'] = $arParams['SHOW_ONE_CLICK_BUY'] == 'Y';
if ($arResult['SHOW_ONE_CLICK_BUY']) {
	$arParams['SHOW_ONE_CLICK_BUY'] = 'N';
}
CatalogHelper::fixItems($arResult, $arParams);
// var_dump('cb CatalogHelper', $GLOBALS['arrFilterProp']);
// var_dump('cb CatalogHelper', $arParams);
?>