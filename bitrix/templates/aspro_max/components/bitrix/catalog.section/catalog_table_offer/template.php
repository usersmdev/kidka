				...
				<div class="table-view__item item bordered box-shadow main_item_wrapper" id="<?=$this->GetEditAreaId($arItem['ID']);?>" data-id="<?=$arItem["ID"]?>" data-product_type="<?=$arItem["CATALOG_TYPE"]?>">
					<div class="table-view__item-wrapper item_info catalog-adaptive flexbox flexbox--row">
						...
						<div class="item-info">
							...
							<div class="wrapp_stockers sa_block" data-fields='<?=Json::encode($arParams["FIELDS"])?>' data-user-fields='<?=Json::encode($arParams["USER_FIELDS"])?>'>
						...
						<div class="item-actions flexbox flexbox--row">
							...
							<div class="item-buttons item_<?=$arItem["ID"]?>">
								<div class="small-block counter_wrapp list clearfix n-mb">
									...
									<?endif;?>
									<div class="button_block <?=(in_array($arItem["ID"], $arParams["BASKET_ITEMS"]) || $arAddToBasketData["ACTION"] == "ORDER" || ($arAddToBasketData["ACTION"] == 'MORE' || !$arAddToBasketData["CAN_BUY"]) || !$arAddToBasketData["OPTIONS"]["USE_PRODUCT_QUANTITY_LIST"] ? "wide" : "");?>">
										<!--noindex-->
