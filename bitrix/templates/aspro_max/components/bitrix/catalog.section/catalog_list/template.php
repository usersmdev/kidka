				...
				<div class="list_item item_info catalog-adaptive flexbox flexbox--row <?=($arItem["OFFERS"] ? 'has-sku' : '')?>" id="<?=$arItemIDs["strMainID"];?>">
					...
					<div class="description_wrapp">
						<div class="description">
							<div class="wrapp_stockers md-store sa_block" data-fields='<?=Json::encode($arParams["FIELDS"])?>' data-user-fields='<?=Json::encode($arParams["USER_FIELDS"])?>' <?=($arParams["SHOW_RATING"] == "Y" ? 'with-rating' : '');?>>
