...
<?if($arResult['ITEMS']):?>
	...
	<?if($arParams['MENU_BANNER'] && $arParams['SHOW_ALL_ELEMENTS'] != 'N'):?>
		<div class="owl-carousel owl-theme owl-bg-nav short-nav owl-dots owl-hidden" data-plugin-options='{"items": "1", "autoplay" : false, "autoplayTimeout" : "3000", "smartSpeed":1000, "dots": true, "nav": true, "loop": false, "rewind":true, "margin": 10}'>
	<?endif;?>
