...
foreach($arResult['DISPLAY_PROPERTIES_FORMATTED'] as $PCODE => $arProperty)
{
	if(in_array($PCODE, array('LINK_OFFERS', 'LINK_CONTENTS')))
		unset($arResult['DISPLAY_PROPERTIES_FORMATTED'][$PCODE]);
}