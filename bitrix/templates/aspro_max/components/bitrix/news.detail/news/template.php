...
$templateData = array(
	...
	'LINK_OFFERS' => $arResult['DISPLAY_PROPERTIES']['LINK_OFFERS']['VALUE'],
	'LINK_CONTENTS' => $arResult['DISPLAY_PROPERTIES']['LINK_CONTENTS']['VALUE'],
		...
		<div class="inner_wrapper_text">
			<div class="content-text <?=($bWideText ? 'wide-text' : '');?> muted777">
				...
				<? if (!empty($arResult['PROPERTIES']['VIDEO']['VALUE'])): ?>
					<?
					$videoLink = VideoUrlUtils::getUrl($arResult['PROPERTIES']['VIDEO']['VALUE']);
					?>
