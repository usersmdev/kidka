<?
	...
	if (Loader::includeModule("catalog"))
	{
		...
		if ((isset($arCurrentValues['ELEMENT_IBLOCK_ID']) && (int)$arCurrentValues['ELEMENT_IBLOCK_ID']) > 0)
		{
			$arSKU = CCatalogSKU::GetInfoByProductIBlock($arCurrentValues['ELEMENT_IBLOCK_ID']);
	...
	if (0 < intval($arCurrentValues['ELEMENT_IBLOCK_ID']))
	{
	...
	$arUserFields = $USER_FIELD_MANAGER->GetUserFields('IBLOCK_'.$arCurrentValues['ELEMENT_IBLOCK_ID'].'_SECTION', 0, LANGUAGE_ID);
	...
	$rsProps = CIBlockProperty::GetList(
		...
		array('IBLOCK_ID' => $arCurrentValues['ELEMENT_IBLOCK_ID'], 'ACTIVE' => 'Y')
	);
	...
	if(CMax::GetFrontParametrValue('REVIEWS_VIEW') == 'EXTENDED') {
		$arTemplateParametersParts[] = array(
