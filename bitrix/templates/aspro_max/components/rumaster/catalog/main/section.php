...
<div class="main-catalog-wrapper">
	<div class="section-content-wrapper <?=($bShowLeftBlock ? 'with-leftblock' : '');?>">
		...
		if($section)
		{
			...
			$arElementFilter = ["PROPERTY_SECTION_ID" => CatalogHelper::getSectionWithSubsectionIds($arSection["ID"]), "ACTIVE" => "Y", "INCLUDE_SUBSECTIONS" => $arParams["INCLUDE_SUBSECTIONS"], "IBLOCK_ID" => $arParams["ELEMENT_IBLOCK_ID"]];
